                                            ...
                                            <div className='col-sm-6 mb-2 text-end'>
                                                    ...
                                                    <button className='btn btn-dark'
                                                        ...
                                                        onClick={() => {
                                                            if(studentTicketNumber === 0 && adultTicketNumber === 0) {
                                                                toast.warning("Veuillez sélectionner un billet pour continuer", {
                                                                    theme: "dark",
                                                                    position: "top-center"
                                                                })
                                                            } else {
                                                ...
                                                :  
                                                    <button className='btn btn-outline-dark'
                                                        ...
                                                        onClick={() => setTicketItem("ticketSection")}>Modifier</button>}
                                            </div>
                                ...
                                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                                    <div class="accordion-body">
                                        <section>
                                                <div className='row '>
                                                    <div className='col-sm-6 text-start'>
                                                        <p>Après avoir sélectionné le film et la séance, vous devez choisir le type de billet.
                                                            Si vous êtes étudiant, n'oubliez pas de vous munir de votre carte d'identité.</p>
                                                    </div>
                                                </div>
                                            ...
                                            <p className='lead text-end mt-3 me-5'>Montant total<strong>{(studentTicketNumber * 37.00 + adultTicketNumber * 68.00).toFixed(2)} DH </strong></p>
                                        </section>
                                        ...
                                        <div className='col-sm-6 mb-2 text-end'>
                                            {ticketItem === "placeSection" ?
                                                <button className='btn btn-dark' data-bs-toggle="collapse" 
                                                    ...
                                                    onClick={() => {
                                                        if (chairNumber !== 0) {
                                                            toast.warning("Veuillez sélectionner autant de sièges que le nombre de billets !", {
                                                                theme: "dark",
                                                                position: "top-center"
                                                            })
                                                        } else {
                                ...
                                <div className='row pt-3 pb-1 px-4 align-items-center'>
                                        ...
                                        <div className='col-sm-6 mb-2 text-end'>
                                            {ticketItem === "paySection" ?
                                                <h3>Total : {(studentTicketNumber * 37.00 + adultTicketNumber * 68.00).toFixed(2)} DH</h3>
                                            : null}
                                        </div>
                                    ...
                                    <Form className='row justify-content-center align-items-start'>
                                        <div className='col-sm-12 col-md-6'>
                                            <div class="imput-group form-floating has-validation mb-3">
                                                <TextInputField name="fullName" type="text" class="form-control" id="fullName" placeholder="Nom - Prénom" required/>
                                                <label for="fullName">Nom - Prénom</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <TextInputField name="email" type="email" class="form-control" id="email" placeholder="Email" required/>
                                                <label for="email">Email</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <TextInputField name="phone" type="tel" class="form-control" id="phone" placeholder="+212** *** ****" required/>
                                                <label for="phone">Téléphone - +212** *** **** </label>
                                            </div>
                                        ...
                                        <div className='col-sm-12 col-md-6 mb-3'>
                                            <div class="form-floating mb-3">
                                                <Cleave class="form-control" id="floatingCardNumber" placeholder='Numéro de la carte de crédit' required
                                                options={{creditCard:true}} />
                                                <label for="floatingCardNumber">Numéro de la carte de crédit</label>
                                            </div>
                                            <div className='row'>
                                                <div className='col-sm-6'>
                                                    <div class="form-floating mb-3">
                                                        <Cleave type="text" class="form-control" id="floatingCardLastDate" placeholder='Date limite' required
                                                        options={{date:true, datePattern: ['m','y']}} />
                                                        <label for="floatingCardLastDate">Date limite</label>
                                                    </div>
                                                </div>
                                                <div className='col-sm-6'>
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control"  maxlength="3" size="3"  id="floatingSecurityNumber" placeholder="Numéro de sécurité" required/>
                                                        <label for="floatingSecurityNumber">CCV</label>
                                                    </div>
                                                </div>
                                                <p className='text-start'> <input class="form-check-input me-3" type="checkbox" value="" aria-label="Checkbox for following text input" required/>J'ai lu et j'approuve lesconditions d'information préalables et le
                                        ...
                                        <div className='text-end mt-1'>
                                            <button type='submit' className='btn btn-dark col-3'>Paiement</button>
                                        </div>
                                    </Form>
                                </Formik>
                            </div>
