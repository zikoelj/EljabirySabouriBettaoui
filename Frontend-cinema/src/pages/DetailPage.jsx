    ...
    function sendCommentText() {
        ...
        if(userFromRedux) {
            if(commentText.trim().length > 0) {
                ...
                toast.warning("Votre commentaire ne peut pas être vide !", {
                    theme: "light",
                    position: "top-center"
                });
            }
  ...
  return (
    <div>
            ...
            <div className=' container mt-5'>
                <div className='row gx-0 pt-2 justify-content-center align-items-start'>
                    ...
                    <div className='col-sm-12 col-md-6 text-start text-light'>
                        ...
                        <hr/>
                        <h5>Directeur : {movie?.directorName}</h5>
                        <h5>Acteurs : {actors?.map(actor => (
                            actor + " ,"
                        ))}
                        </h5>
                        <div class="row gy-1 justify-content-start align-items-end mt-5">
                            ...
                            <div className='col-sm-4'>
                                <button class="detail-page-btn btn btn-light btn-lg col-12" type="button"
                                    ...
                                    }}><strong>Acheter un billet </strong></button>
                            ...
                            <div className='col-sm-4'>
                                <button class="detail-page-btn btn btn-light btn-lg col-12" type="button"
                                    ...
                                    }}><strong>Laisser un commentaire</strong></button>

                            </div>
                            <div className='col-sm-4'>
                                <button class="detail-page-btn btn btn-light btn-lg col-12" type="button"
                                    data-bs-toggle="modal" data-bs-target="#movieTrailerModal"><strong>Bande-annonce</strong></button>
            ...
            <div className='container'>
                <div className='row justify-content-between ms-0 ms-md-5 ps-0 ps-md-5'>
                    <div className='col-sm-4 text-start'>
                        <p> <strong> Date de la vision : </strong> {dateConvert( movie.releaseDate) }</p>
                        <p> <strong>Durée de l'enquête : </strong>{movie.duration} Procès-verbal</p>
                        <p><strong>Genre : </strong>{movie.categoryName}</p>
                    </div>
                    <div className='col-sm-8 text-start'>
                        <p><strong>Sujet :</strong>{movie.description}</p>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div className='col-sm-8 ps-3 mt-2'>
                        <button type="button" class="select-saloon-button btn btn-primary col-12"
                         data-bs-toggle="modal" data-bs-target="#saloonModal">
                            <strong>Choisir le cinéma</strong> <i class="fa-solid fa-caret-down"></i>
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div className='row gy-2 justify-content-start align-items-start'>
                    <div className='col-sm-12 col-md-6 text-start'>
                       ...
                       <div style={{height: "200px", overflow:"scroll",overflowX: "hidden"}}>
                            {comments.length == 0 ? (
                                <p className='lead mt-4'>Vous écrivez le premier commentaire</p>
                            ): null}
                    ...
                    <div className='col-sm-12 col-md-6 text-start'>
                        <h3>Laisser un commentaire</h3>
                            <textarea id="commentArea" className='text-dark mb-3' placeholder='Votre commentaire' onChange={(e) => setCommentText(e.target.value)} ></textarea>
                            <button class="comment-btn btn btn-dark btn-lg col-12" type="button" onClick={() => sendCommentText()}><strong>Envoyer</strong></button>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section className='p-5'>
            ...
            <h3 className='text-center mb-4'>Autres films dans Vision</h3>
            <Swiper
                slidesPerView={5}
                spaceBetween={0}
                pagination={{
        ...
        <div class="modal fade" id="movieTrailerModal" tabindex="-1" aria-labelledby="movieTrailerLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="movieTrailerLabel">Bande-annonce</h5>
        ...
        <div class="modal fade" id="saloonModal" tabindex="-1" aria-labelledby="saloonModalLabel" aria-hidden="true" style={{height:"50%", overflow:'auto'}}>
            <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable" >
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="saloonModalLabel">Sélectionner une ville</h5>
            ...
            <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        {/* Envoyer à la page d'achat de billets */}
                    </div>
