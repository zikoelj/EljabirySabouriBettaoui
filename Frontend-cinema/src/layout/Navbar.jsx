    ...
    <div>
        <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
            ...
            <Link to={"/"} style={{textDecoration:"none"}}>
                <a class="navbar-brand"> Cinema IDLD </a>
            </Link>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto align-items-center">
                        {userFromRedux?.roles[0] === "ADMIN" ? 
                            <li class="nav-item"><a class="nav-link" href="#!" onClick={() => navigate("/addMovie")}>Ajouter un film</a></li>
                        : null}
                        ...
                        <div className='col-sm-12 col-md-6'>
                            <div className='row justify-content-center align-items-start'>
                                <div className='col-sm-7'>
                                    <h3 className='text-start ms-3'>Vision</h3>
                                    ...
                                    <a href='#!' className='text-decoration-none'><strong> Tous </strong> </a>
                                </div>
                                <div className='col-sm-5'>
                                    <h3 className='text-start ms-3'>Prochainement</h3>
                                    {/* For loop */}
                                    <div className='ms-3 mt-2'>
